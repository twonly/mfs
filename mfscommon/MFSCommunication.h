...
#define MATOMA_FUSE_MKNOD (PROTO_BASE+701)
#define MATOMA_FUSE_MKDIR (PROTO_BASE+702)
#define MATOMA_FUSE_UNLINK (PROTO_BASE+703)
#define MATOMA_FUSE_RMDIR (PROTO_BASE+704)
#define MATOMA_FUSE_RENAME (PROTO_BASE+705)
